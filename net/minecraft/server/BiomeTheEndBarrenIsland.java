...
public class BiomeTheEndBarrenIsland extends BiomeBase {
    ...
    public BiomeTheEndBarrenIsland() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(BiomeTheEndBarrenIsland.av, BiomeTheEndBarrenIsland.au)).a(BiomeBase.Precipitation.NONE).a(BiomeBase.Geography.THEEND).a(0.1F).b(0.2F).c(0.5F).d(0.5F).a(4159204).b(329011).a((String) null));
