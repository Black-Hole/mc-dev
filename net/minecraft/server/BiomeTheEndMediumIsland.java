...
public class BiomeTheEndMediumIsland extends BiomeBase {
    ...
    public BiomeTheEndMediumIsland() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(BiomeTheEndMediumIsland.av, BiomeTheEndMediumIsland.au)).a(BiomeBase.Precipitation.NONE).a(BiomeBase.Geography.THEEND).a(0.1F).b(0.2F).c(0.5F).d(0.5F).a(4159204).b(329011).a((String) null));
