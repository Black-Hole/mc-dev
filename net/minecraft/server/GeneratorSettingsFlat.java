...
public class GeneratorSettingsFlat extends GeneratorSettingsDefault {
    ...
    private static final WorldGenFeatureComposite<WorldGenFeatureLakeConfiguration, WorldGenDecoratorLakeChanceConfiguration> G = BiomeBase.a(WorldGenerator.am, new WorldGenFeatureLakeConfiguration(Blocks.WATER), BiomeBase.L, new WorldGenDecoratorLakeChanceConfiguration(4));
    private static final WorldGenFeatureComposite<WorldGenFeatureLakeConfiguration, WorldGenDecoratorLakeChanceConfiguration> H = BiomeBase.a(WorldGenerator.am, new WorldGenFeatureLakeConfiguration(Blocks.LAVA), BiomeBase.K, new WorldGenDecoratorLakeChanceConfiguration(80));
